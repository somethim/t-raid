                            ...
                            <View style={styles.podiumContainer}>
                                {leaderboard[1] && (
                                    <View style={[styles.podiumItem, styles.podiumItem2]}>
                                        <Image source={require('./components/ui/second_place.png')} style={styles.podiumIcon} />
                                        <Text style={styles.podiumUser}>{leaderboard[1].username}</Text>
                                        <Text style={styles.podiumScore}>{leaderboard[1].score} pts</Text>
                                    </View>
                                )}
                                {leaderboard[0] && (
                                    <View style={[styles.podiumItem, styles.podiumItem1]}>
                                        <Image source={require('./components/ui/first_place.png')} style={styles.podiumIcon} />
                                        <Text style={styles.podiumUser}>{leaderboard[0].username}</Text>
                                        <Text style={styles.podiumScore}>{leaderboard[0].score} pts</Text>
                                    </View>
                                )}
                                {leaderboard[2] && (
                                    <View style={[styles.podiumItem, styles.podiumItem3]}>
                                        <Image source={require('./components/ui/third_place.png')} style={styles.podiumIcon} />
                                        <Text style={styles.podiumUser}>{leaderboard[2].username}</Text>
                            ...
                            <FlatList
                                ...
                                renderItem={({ item, index }) => (
                                    <View style={styles.rowCard}>
                                        <Text style={styles.rowText}>#{index + 4} {item.username} {item.score} pts</Text>
