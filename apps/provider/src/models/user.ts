...
import {repository, withAuthenticatedMutationContext, withAuthenticatedQueryContext, withQueryContext,} from "../utils";
...
export const deleteCurrentUser = withAuthenticatedMutationContext(
    async (ctx) => {
        ...
        await update(ctx, {
            ...
            data: {
                deletionTime: now,
                // fullName: `DELETED USER ${uniqueDeletionIdentifier}`,
                email: undefined,
                phone: undefined,
                birthdate: undefined,
