...
export const MiniCarIcon = (props: IconProps) => (
  <svg
    viewBox="0 0 24 24"
    width={24}
    height={24}
  ...
  >
    ...
    />
    <path d="M8 17.5C8 18.6046 7.10457 19.5 6 19.5C4.89543 19.5 4 18.6046 4 17.5C4 16.3954 4.89543 15.5 6 15.5C7.10457 15.5 8 16.3954 8 17.5Z" />
    <path d="M20 17.5C20 18.6046 19.1046 19.5 18 19.5C16.8954 19.5 16 18.6046 16 17.5C16 16.3954 16.8954 15.5 18 15.5C19.1046 15.5 20 16.3954 20 17.5Z" />
    <path
      d="M17.5 10C14.5 9 11 8.5 7 9C7 7 8 5 8.5 4.5"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path d="M8 11H9" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
