...
export const H1 = ({ className, asChild = false, ...props }: H1Props) => {
  const Component = asChild ? Slot.Text : TextPrimitive;
  ...
  return (
    <Component
      ...
      className={cn(
        "font-extrabold font-header text-4xl text-foreground tracking-tight lg:text-5xl",
        className,
      )}
      {...props}
    />
...
export const H2 = ({ className, asChild = false, ...props }: H2Props) => {
  ...
  return (
    <Component
      ...
      maxFontSizeMultiplier={1.2}
      className={cn(
        "font-header font-semibold text-3xl text-foreground tracking-tight first:mt-0",
        className,
      )}
      {...props}
    />
...
export const H3 = ({ className, asChild = false, ...props }: H3Props) => {
  ...
  return (
    <Component
      ...
      maxFontSizeMultiplier={1.2}
      className={cn(
        "font-header font-semibold text-2xl text-foreground tracking-tight",
        className,
      )}
      {...props}
    />
...
export const H4 = ({ className, asChild = false, ...props }: H4Props) => {
  ...
  return (
    <Component
      ...
      maxFontSizeMultiplier={1.2}
      className={cn(
        "font-header font-semibold text-foreground text-xl tracking-tight",
        className,
      )}
      {...props}
    />
...
const Paragraph = ({
  ...
  return (
    <Component
      maxFontSizeMultiplier={1.2}
      className={cn("font-body text-base text-foreground", className)}
      {...props}
    />
  );
};
