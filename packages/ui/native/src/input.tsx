...
export const inputVariants = cva(
  "flex-1 rounded-md font-body text-foreground text-lg leading-[1.25] file:border-0 file:bg-transparent file:font-medium placeholder:text-foreground-dimmed",
  {
    variants: {
      variant: {
        border:
