...
const AnimatedSelectContent = Animated.createAnimatedComponent(
  ...
  return (
    <SelectPrimitive.Portal>
      ...
      <AnimatedSelectContent
        ...
        exiting={FadeOut}
        className={cn(
          "relative z-[1000] max-h-96 w-fit overflow-hidden rounded-xl border border-border bg-accent shadow shadow-emphasis-dimmed/10",
          className,
        )}
